...
const DUMMY_ROLES: RoleInfo[] = [
    ...
    },
    {
        id: '3',
        name: 'Support Agent',
        description: 'Access to feedback and trainee complaints only',
        usersCount: 12,
        status: 'Active',
    },
    {
...
export const RolesPage = () => {
    ...
    // Filter
    const filtered = DUMMY_ROLES.filter(
        (r) =>
    ...
    return (
        <>
                                        ...
                                        <td>
                                            <div className="actions-col">
                                                ...
                                                <button
                                                    ...
                                                    title="Edit Role"
                                                    onClick={() =>
                                                        navigate(`/roles-permissions/edit/${r.id}`)
                                                    }
                                                >
            ...
            {/* View Overlay */}
            {viewingRole && <ViewOverlay role={viewingRole} onClose={() => setViewingRole(null)} />}
        </>
    );
};
