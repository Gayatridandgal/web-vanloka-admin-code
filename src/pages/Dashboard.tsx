        ...
        <>
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[9999] flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl p-10 text-center max-w-md w-full shadow-2xl">
                        ...
                        <p className="text-sm text-slate-500 leading-relaxed mb-8">
                            You've been inactive for <strong>5 minutes</strong>. Please refresh the
                            page to continue.
                        </p>
                        <button
            ...
            <div className="page-body">
                    ...
                    <div className="stat-card">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                                ...
                                <span className="text-[14px] font-black text-emerald-600 uppercase tracking-tight">
                                    ONLINE
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                style={{ color: countdown < 60 ? '#DC2626' : 'inherit' }}
                            >
                                {mmss}
                            </div>
                        </div>
                ...
                <div className="dashboard-grid" style={{ padding: '0 24px 24px' }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        onClick={() => {
                                            const map = (window as unknown as { dashMap: unknown })
                                                .dashMap;
                                            if (map)
                                                (
                                                    map as { invalidateSize: () => void }
                                                ).invalidateSize();
                                        }}
                                    >
                            ...
                            >
                                <MapContainer
                                    ...
                                    ref={(m) => {
                                        if (m)
                                            (window as unknown as { dashMap: typeof m }).dashMap =
                                                m;
                                    }}
                                >
                                    <TileLayer
                                ...
                                <div className="map-overlay-content">
                                    <div className="bg-white/95 backdrop-blur-md rounded-2xl p-8 text-center shadow-xl border border-slate-200 max-w-[340px]">
                                        ...
                                        <p className="text-sm text-slate-500 font-medium leading-relaxed">
                                            Your fleet is currently offline. Connect vehicle devices
                                            to begin real-time operational tracking.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        Real-time logs for session overrides & admin actions.
                                    </p>
                                </div>
                                <button
                                    className="btn btn-secondary"
                                    style={{ fontSize: 11, padding: '8px 16px', borderRadius: 12 }}
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                        <div
                            className="vehicle-select-panel"
                            style={{
                                width: '100%',
                                borderRadius: 24,
                                padding: 32,
                            ...
                            >
                                ...
                                {STATUS_ITEMS.map((s) => (
                                    ...
                                    >
                                        ...
                                        <Badge
                                            variant={
                                                s.badgeCls.includes('green')
                                                    ? 'green'
                                                    : s.badgeCls.includes('amber')
                                                      ? 'orange'
                                                      : 'red'
                                            }
                                        >
