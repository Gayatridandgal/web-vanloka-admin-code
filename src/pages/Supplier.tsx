                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-2">
                    {[
                        ...
                        },
                        {
                            ...
                            val: suppliers.filter((s) => s.status === 'Active').length,
                            color: '#059669',
                            bg: '#ECFDF5',
                        ...
                        {
                            label: 'Total Devices',
                            val: suppliers.reduce((acc, s) => acc + s.devices.length, 0),
                            color: '#2563EB',
                            bg: '#EFF6FF',
                ...
                >
                    ...
                    <div style={{ position: 'relative' }} className="w-full sm:w-auto">
                        <select
                            ...
                            style={{ width: '100%', minWidth: 160, paddingRight: 32 }}
                            value={statusFilter}
                                ...
                                {paginated.map((s, idx) => (
                                    <tr key={s.id}>
                                        ...
                                        <td>
                                            <button
                                                onClick={() =>
                                                    navigate(`/suppliers/${s.id}/devices`)
                                                }
                                                style={{
                                                    background: '#F0F9FF',
                                                    color: '#0284C7',
                    ...
                    >
                        ...
                        <div style={{ padding: 32 }}>
                            ...
                            >
                                ...
                                <div>
                                    <h3 style={{ fontSize: 22, fontWeight: 900, marginBottom: 4 }}>
                                        {viewingSupplier.name}
                                    </h3>
                                    <Badge
                                        variant={
                                            viewingSupplier.status === 'Active' ? 'green' : 'slate'
                                        }
                                    >
                            ...
                            >
                                {[
                                    {
                                        label: 'Location',
                                        val: viewingSupplier.location,
                                        icon: <MapPin size={14} />,
                                    },
                                    {
                                        label: 'Contact Person',
                                        val: viewingSupplier.contactPerson,
                                        icon: <User size={14} />,
                                    },
                                    {
                                        label: 'Phone',
                                        val: viewingSupplier.phone,
                                        icon: <Phone size={14} />,
                                    },
                                    {
                                        label: 'Email Address',
                                        val: viewingSupplier.email,
                                        icon: <Mail size={14} />,
                                    },
                                    {
                                        label: 'Devices Provided',
                                        val: `${viewingSupplier.devices.length} Units`,
                                        icon: <MonitorSmartphone size={14} />,
                                    },
                                    {
                                        label: 'Supplier ID',
                                        val: viewingSupplier.id,
                        ...
                        >
                            <button
                                ...
                                onClick={() => navigate(`/suppliers/${viewingSupplier.id}/devices`)}
                            >
                                Manage Devices
                            </button>
                            <button
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            ? All associated device records will remain but the link will be
                            detached.
                        </p>
                        <div
