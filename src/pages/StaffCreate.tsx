...
const Grid = ({
  ...
  // Translate cols string to a tailwind responsive grid class roughly
  let gridClass = "grid gap-4 ";
  if (cols === "1fr 1fr") gridClass += "grid-cols-1 lg:grid-cols-2";
  else if (cols === "1fr 1fr 1fr") gridClass += "grid-cols-1 md:grid-cols-2 lg:grid-cols-3";
  else if (cols === "1fr 1fr 1fr 1fr") gridClass += "grid-cols-1 md:grid-cols-2 lg:grid-cols-4";
  else gridClass += "grid-cols-1"; // Default fallback
...
export const StaffCreate = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!form.primaryName.trim())
      e.primaryName = "Primary contact name required";
    if (!form.primaryPhone.trim())
      e.primaryPhone = "Primary contact phone required";
    setErrs(e);
      ...
      <>
        ...
        <div className="page-header">
          <div>
            ...
            <div className="breadcrumb">
              Admin <span>/</span> Staff Management <span>/</span> Add New
              Employee
            </div>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <button
              className="lg:hidden btn btn-secondary px-2 shrink-0"
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: 12, color: "var(--muted)", marginBottom: 32 }}
            >
              Status:{" "}
              <span
                style={{
                  fontWeight: 800,
                  color:
                    form.accountStatus === "Active" ? "#059669" : "#64748B",
                }}
              >
                {form.accountStatus}
              </span>
  ...
  return (
    <>
      ...
      <div className="page-body">
        {/* Mobile back button with full width */}
          ...
          <Card>
            ...
            <Body>
              <div className="flex flex-col lg:flex-row gap-6">
                {/* Photo */}
                <div style={{ flexShrink: 0 }} className="flex flex-col max-lg:items-center">
                  ...
                  <div data-err={errs.joiningDate ? "1" : undefined}>
                    ...
                    <input
                      ...
                      style={{
                        width: "100%",
                        boxSizing: "border-box",
                        borderColor: errs.joiningDate ? "#DC2626" : undefined,
                      }}
                    />
                  ...
                  <div data-err={errs.primaryPhone ? "1" : undefined}>
                    ...
                    <input
                      ...
                      style={{
                        width: "100%",
                        boxSizing: "border-box",
                        borderColor: errs.primaryPhone ? "#DC2626" : undefined,
                      }}
                    />
                      ...
                      style={
                        {
                          ...
                          borderRadius: 10,
                          border: "2px dashed var(--border)",
                          background: form[key] ? "#F5F3FF" : "var(--surface)",
                          cursor: "pointer",
                          gap: 6,
                          borderColor: form[key] ? "var(--primary)" : undefined,
