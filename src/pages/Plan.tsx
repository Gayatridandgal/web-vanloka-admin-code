...
export const PlanPage = () => {
    ...
    return (
        <>
            ...
            <div className="page-body">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    {[
                        ...
                        {
                            label: 'Inactive',
                            val: INITIAL_PLANS.filter((p) => p.status === 'Inactive').length,
                            color: '#DC2626',
                            bg: '#FEE2E2',
                        ...
                        <tbody>
                            {paginated.map((p) => (
                                <tr key={p.id}>
                                    ...
                                    <td style={{ fontSize: 12, fontWeight: 600, color: '#475569' }}>
                                        {p.vehiclesIncluded}
                                    </td>
                                    <td
                                        style={{
            ...
            <AnimatePresence>
                {viewingPlan && (
                    <ViewOverlay plan={viewingPlan as Plan} onClose={() => setViewingPlan(null)} />
                )}
            </AnimatePresence>
        </>
    );
