      ...
      try {
        ...
        const rows: Staff[] = json.map((r, i) => {
          ...
          return {
            ...
            designation:
              r["Designation"] || r["Role"] || r["designation"] || "—",
            department: r["Department"] || r["department"] || "—",
            employmentType: (r["Employment Type"] ||
              r["employmentType"] ||
              "Full Time") as Staff["employmentType"],
            joiningDate:
              r["Join Date"] || r["Joining Date"] || r["joiningDate"] || "—",
...
const ExportOverlay = ({
  ...
  const [companyName, setCompanyName] = useState(
    defaultTitle || "Staff Management Report",
  );
    ...
    >
      <div
        style={{
          ...
          overflow: "auto",
          boxShadow:
            "0 24px 64px rgba(0,0,0,.2), 0 0 0 1px rgba(124,58,237,.08)",
        }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
...
export const StaffPage = () => {
  ...
  const buildPdf = useCallback(
    (opts: {
      ...
      doc.text(
        opts.subtitle || `Generated on ${new Date().toLocaleString()}`,
        textX,
        26,
      );
      ...
      doc.text(
        opts.footerText || "Confidential — For internal use only",
        10,
        ph - 6,
      );
  ...
  const [exportIndividualStaff, setExportIndividualStaff] =
    ...
    <>
      <div className="page-header">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {/* Actions - Hidden on mobile, shown on desktop in header */}
      ...
      <div className="page-body">
        ...
        <div className="lg:hidden flex flex-col w-full gap-2 mb-2">
          <button
        ...
        <div className="hidden lg:block table-card">
                      ...
                      <td>
                        <div className="actions-col">
                          <button
                            ...
                            title="View Details"
                            onClick={() => setViewStaff({ s, idx: globalIdx })}
                          >
        ...
        <div className="lg:hidden flex flex-col gap-3.5">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <button
                      className="act-btn"
                      style={{ width: 36, height: 36, color: "#7C3AED" }}
                      onClick={() => setExportIndividualStaff(s)}
                    >
                      <span className="material-symbols-outlined ms">
                        picture_as_pdf
          ...
          <Pagination
            info={`Showing ${filtered.length} employees`}
            pages={[1, 2, 3]}
            current={1}
            className="mt-2"
          />
