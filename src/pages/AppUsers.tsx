            ...
            <div className="page-body">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    {[
                        ...
                        {
                            label: 'Android Users',
                            val: users.filter((u) => u.device === 'Android').length,
                            color: '#3DDC84',
                            bg: '#F1FDF6',
                        ...
                        {
                            label: 'iOS Users',
                            val: users.filter((u) => u.device === 'iOS').length,
                            color: '#000000',
                            bg: '#F8FAFC',
                            icon: <Iphone size={20} />,
                        },
                        ...
                        <div style={{ padding: 32 }}>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <Badge
                                        variant={viewingUser.status === 'Active' ? 'green' : 'red'}
                                    >
                                        {viewingUser.status}
                                    </Badge>
                                </div>
                            ...
                            >
                                {[
                                    {
                                        label: 'Email Address',
                                        val: viewingUser.email,
                                        icon: <Mail size={14} />,
                                    },
                                    {
                                        label: 'Phone Number',
                                        val: viewingUser.phone,
                                        icon: <Phone size={14} />,
                                    },
                                    {
                                        label: 'Organisation',
                                        val: viewingUser.organisation,
                                        icon: <Building2 size={14} />,
                                    },
                                    {
                                        label: 'Org Type',
                                        val: viewingUser.orgType,
                                        icon: <Briefcase size={14} />,
                                    },
                                    {
                                        label: 'Platform',
                                        val: viewingUser.device,
                                        icon: <Smartphone size={14} />,
                                    },
                                    {
                                        label: 'Last active',
                                        val: viewingUser.lastActive,
                                ...
                                <div className="form-group">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setEditingUser({
                                                ...editingUser,
                                                status: e.target.value as AppUser['status'],
                                            })
                                        }
                                    >
                                        <option value="Active">Active</option>
