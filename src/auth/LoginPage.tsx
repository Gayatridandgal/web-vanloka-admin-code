  ...
  return (
    <button
      ...
      style={{
        ...
        transform:
          h && !loading && !disabled ? "translateY(-1px)" : "translateY(0)",
  ...
  return (
    <div style={{ marginTop: 4 }}>
      ...
      >
        ...
        <span
          style={{ fontSize: 11, fontWeight: 700, color: strengthColor(s) }}
        >
          {strengthLabel(s)}
        </span>
      </div>
    ...
    >
      <div
        style={{
          ...
          margin: "0 auto 28px",
          boxShadow:
            "0 0 50px rgba(255,255,255,0.10),0 8px 28px rgba(0,0,0,0.18)",
        }}
      >
      ...
      >
        Your complete fleet operations platform — built for speed, reliability,
        and scale.
      </p>
      <div
        style={{
      ...
      >
        ...
        >
          <div style={{ width: "100%", maxWidth: 420 }}>
            ...
            >
              © 2026 VanLoka. All rights reserved. · Protected by 256-bit
              encryption.
            </p>
          </div>
        </div>
