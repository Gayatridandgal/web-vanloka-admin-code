    ...
    <div className="auth-wrap">
        <div
            style={{
                ...
                width: 420,
                padding: 44,
                boxShadow: '0 24px 80px rgba(124,58,237,0.12),0 8px 32px rgba(0,0,0,0.07)',
            }}
        >
            {children}
        </div>
...
/* ── Forgot Password ── */
export const ForgotScreen = ({ onSend, onBack }: { onSend: () => void; onBack: () => void }) => (
    <CardWrap>
        <div
            style={{
                width: 56,
        ...
        <button className="btn btn-primary btn-full" style={{ marginBottom: 14 }} onClick={onSend}>
        ...
        <button className="btn btn-secondary btn-full" onClick={onBack}>
            <span className="material-symbols-outlined ms">arrow_back</span>Back to Login
        </button>
        <div
            style={{
                marginTop: 20,
        ...
        <div className="auth-copyright">© 2024 FleetAdmin Organization • Secure Infrastructure</div>
    </CardWrap>
);

/* ── Reset Password ── */
export const ResetScreen = ({ onUpdate, onBack }: { onUpdate: () => void; onBack: () => void }) => (
    <CardWrap>
        <div
            style={{
                width: 56,
        ...
        <div className="pw-req">
            ...
            <div className="pw-req-item met">
                <span className="material-symbols-outlined ms">check_circle</span>At least 8
                characters long
            </div>
            <div className="pw-req-item">
                <span className="material-symbols-outlined ms">radio_button_unchecked</span>
